model Lab6_2
  ...
  parameter Integer N = 11600; // Общая численность популяции
  parameter Integer I0 = 260; // Начальное число заражённых
  parameter Integer R0 = 48; // Начальное число имеющих иммунитет
